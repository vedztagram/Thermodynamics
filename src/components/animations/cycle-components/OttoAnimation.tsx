...
interface OttoAnimationProps {
  params: CycleParams;
  isAnimating: boolean;
}

const OttoAnimation = ({ params, isAnimating }: OttoAnimationProps) => {
  ...
  const getPistonY = () => {
    ...
    switch (position) {
      ...
      case 2:
        return baseY; // TDC after combustion
      case 3:
  ...
  const getCylinderColor = () => {
    switch (position) {
      ...
      case 2:
        return getHeatColor(params.T_3 || 2000); // Hot after combustion
      case 3:
    ...
    <div className="w-full h-full flex items-center justify-center">
      <svg viewBox="0 0 600 250" className="max-w-full max-h-full">
        ...
        <circle
          ...
          r="3"
          fill="yellow"
          className={position === 1 ? "animate-pulse" : ""}
        />
        ...
        <circle
          ...
          strokeWidth="1.5"
        />
        <text x="350" y="90" textAnchor="middle" fill="#333" fontWeight="bold">
          3
        </text>
